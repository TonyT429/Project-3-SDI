...
console.log('"Okay so we have 4 dragons, each with an awesome, if somewhat limited arsenal and we have 4 weapons with 48 rounds of ammo, ',
			'Now the questions is, what is it that you are looking for us to do?", I ask.  "Ahhh, yes.  Well, what we are looking for ',
			'is to permanently close the Doorway from our realm to yours.  You see, we had it closed for the past several hundred years ',
			'unfortunately, the Lock was taken by my evil counterpart.  We mean to retrieve it from her before she can destroy it."  "So, ',
			'you want us to kill this evil woman and recover the Lock, is that it?", I ask.  "No, no, no... you must not kill her!  You ',
			'only need to recover the Lock.  If you kill her, you, you will destroy us all with war.  ');
			
// need a while loop, need a boolean, need method accessor and mutators
// more importantly, need to stop being a writer!  
